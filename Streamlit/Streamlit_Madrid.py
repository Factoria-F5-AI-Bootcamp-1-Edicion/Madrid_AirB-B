...
if selected == "Home":
    ...
    if box== "Conoce Data Home":
        ...
        st.write("Somos una empresa de consultoría de nueva generación especializada en hostelería y turismo, basada en análisis de datos e Inteligencia Artificial")
 ...
 #Pagina Descubre Madrid       
    ...
    if box=="Descubre Madrid":  
       ...
       st.markdown("# Por qué Madrid:")

       st.image("XqMadrid.jfif")

       st.markdown("# Dividida en 21 distritos y 128 barrios, Madrid ofrece una oferta turística impresionate y para todo tipo de clientes : ")
...
#Vizualizacion de la Base de Datos
    ...
    if box== "Dataframe":
        ...
        st.markdown("Se puede mostrar parte de la base datos para su visualización: ")
    ...
    if box== "Precios":
        #Visualizacion de los distritos segun su precio
            ...
            st.markdown("""Aquí podemos observar algunos outliers de precio en zonas que no son tan céntricas, la explicación que le podemos dar es que se celebrara algún evento en fechas determinadas.
            """)
...
#Pagina Barrios del Centro
    ...
    if box== "Barrios del Centro":
        ...
        st.markdown("""
        - Como hemos podido apreciar según los gráficos anteriores, en el distrito del centro tenemos mayor cantidad de anuncios; asi que, vamos a explorar en qué barrios se concentran más dichos anuncios """)
...
#Outliers caso 2
        ...
        st.write("Visualización de los datos con relación a la Pandemia : ")
        ...
        pandemia_mayo.shape
        st.markdown(""" 
                        - Se encuentran 60 anuncios en este mes; ya que, fue en mayo el último mes de confinamiento restrictivo.
